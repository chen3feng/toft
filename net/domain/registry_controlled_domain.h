...
#ifndef TOFT_NET_DOMAIN_REGISTRY_CONTROLLED_DOMAIN_H
#define TOFT_NET_DOMAIN_REGISTRY_CONTROLLED_DOMAIN_H
...
bool SameDomainOrHost(const toft::URI& gurl1, const toft::URI& gurl2, PrivateRegistryFilter filter);
...
#endif  // TOFT_NET_DOMAIN_REGISTRY_CONTROLLED_DOMAIN_H

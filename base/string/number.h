...
/// @param base specify the base to be used for the conversion, 0 means automatic
/// -----------------------------------------------------------------------

bool ParseNumber(const char* str, signed char* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, unsigned char* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, short* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, unsigned short* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, int* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, unsigned int* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, long* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, unsigned long* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, long long* value, char** endptr = NULL, int base = 0);
bool ParseNumber(const char* str, unsigned long long* value, char** endptr = NULL, int base = 0);
...
{
    TOFT_STATIC_ASSERT(std::is_integral<Type>::value, "Type must be integral type");
    char* endptr;

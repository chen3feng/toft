...
#ifndef TOFT_SYSTEM_THREADING_LOCK_FREE_THREAD_POOL_H
#define TOFT_SYSTEM_THREADING_LOCK_FREE_THREAD_POOL_H
...
public:
    explicit LockFreeThreadPool(int32_t min_thread_num = 0,
...
private:
    ...
    LockFreeQueue<TaskNode*> m_pending_tasks;
    LockFreeQueue<TaskNode*> m_completed_tasks;
    LockFreeQueue<ThreadNode*> m_idle_threads;

    int32_t m_min_thread_num;
    int32_t m_max_thread_num;
    Atomic<int32_t> m_cur_thread_num;
    Atomic<int32_t> m_cur_busy_thread_num;
    Atomic<int32_t> m_pending_task_num;
...
#endif // TOFT_SYSTEM_THREADING_LOCK_FREE_THREAD_POOL_H
